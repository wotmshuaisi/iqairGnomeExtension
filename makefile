...
install:
	rsync -av --exclude=.git ./src/ ~/.local/share/gnome-shell/extensions/iqair@wotmshuaisi_github && busctl --user call org.gnome.Shell /org/gnome/Shell org.gnome.Shell Eval s 'Meta.restart("Restarting…")' && gnome-extensions enable iqair@wotmshuaisi_github
